...
**Authors:** Emily Port, Christopher Jacobs, Joseph T. Kider Jr.    
**Published:** ACM SIGGRAPH Motion, Interactive and Games (MIG) 2025    
**Keywords:** Visualization, Computer Games, Motion Processing, Player Behavior Modeling
...
My research interests bridges computer graphics, computer vision, and machine learning with applications that can be used in feature films and visual effects:

- **Neural Rendering:** Gaussian Splatting, novel view synthesis techniques
- **Facial Analysis & Capture:** Facial reconstruction
- **Material Appearance:** Subsurface scattering, real-time material rendering, BRDF analysis