---
title: 'Musiplexity: Classifying Music by Genre using Data Analysis and Machine Learning'
...
<button class="github_button" onclick="window.location.href = 'https://github.com/christopher-jacobs/musiplexity';">
...
<div class="two_image_diagram"style="display: flex; grid-template-columns: 1fr 1fr; gap: 2rem;">
  <div>
    <img src="./images/dense_point_cloud.png" alt="Noise Slice" style="width: 100%;">
    <p class= "image-caption">Fractal-Sum Noise Slice</p>
  </div>
  <div>
    <img src="./images/dense_persist.png" alt="Noise Slice" style="width: 100%;">
    <p class= "image-caption">Fractal-Sum Noise Slice</p>
  </div>
</div>
```
